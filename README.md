...
A simple **rule-based chatbot** built using Python. The chatbot interacts with users through the command line and responds to basic conversational inputs such as greetings, personal queries, and utility-based requests like date and time.
...
* 💬 Handles basic inputs (hello, how are you, etc.)  
* ⏰ Displays current time  
* 📅 Displays current date  
* 🆘 Help command support  
* 👋 Exit functionality (`bye`)  
